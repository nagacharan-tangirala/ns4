...
Core::createVehicleNodes ()
{
  ...
  this->m_netSetup->setupVehicularNet (std::move (this->m_vehicleNodes));
}
...
Core::scheduleMobilityUpdate ()
{
  ...
  this->m_vehicleNodes = this->m_vehicleMobility->addWaypointsBetween (
      currentSimTime, currentSimTime + this->m_streamTime, std::move (this->m_vehicleNodes));
